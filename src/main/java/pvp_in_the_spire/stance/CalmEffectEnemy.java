...
//对敌人使用的平静姿态的动画
//不过可惜原本的那个平静姿态有太多的变量都是私有成员了，那这里只能抄一遍了
public class CalmEffectEnemy extends AbstractGameEffect {
    ...
    public CalmEffectEnemy(AbstractCreature targetMonster) {
        ...
        this.x = targetMonster.hb.cX - MathUtils.random(100.0F, 160.0F) * Settings.scale - 32.0F;
        this.y = targetMonster.hb.cY + MathUtils.random(-50.0F, 220.0F) * Settings.scale - 32.0F;
