...
//抄过来看愤怒姿态动画
public class WrathParticleEffectEnemy extends AbstractGameEffect {
    ...
    public WrathParticleEffectEnemy(AbstractCreature monster) {
        ...
        this.x = monster.hb.cX + MathUtils.random(-monster.hb.width / 2.0F - 30.0F * Settings.scale, monster.hb.width / 2.0F + 30.0F * Settings.scale);
        this.y = monster.hb.cY + MathUtils.random(-monster.hb.height / 2.0F - -10.0F * Settings.scale, monster.hb.height / 2.0F - 10.0F * Settings.scale);
