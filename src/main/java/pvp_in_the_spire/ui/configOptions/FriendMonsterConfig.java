...
public class FriendMonsterConfig extends TailNumSelect{

    public static final UIStrings uiStrings =
            CardCrawlGame.languagePack.getUIString("FriendMonsterConfig");

    //之前选择的row
    public int previousRow = 0;

    public FriendMonsterConfig(float width)
    {
        super(width);
        //设置文本的内容
    ...
    public void changedSelectionTo(DropdownMenu dropdownMenu, int i, String s) {
        //更改是否添加小怪的全局设置
        GlobalManager.friendMonsterFlag = (i>0);
        //判断是否需要发送消息
