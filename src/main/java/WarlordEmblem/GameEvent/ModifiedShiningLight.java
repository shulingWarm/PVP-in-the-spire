package WarlordEmblem.GameEvent;
...
//修改过的闪耀之光，其实就是失去生命随机升级两张牌的那个
public class ModifiedShiningLight extends AbstractImageEvent {

    public static final String ID = "ModifiedShiningLight";
    ...
    private ModifiedShiningLight.CUR_SCREEN screen;

    public ModifiedShiningLight() {
        super(NAME, INTRO, "images/events/shiningLight.jpg");
        this.screen = ModifiedShiningLight.CUR_SCREEN.INTRO;
        ...
        switch (this.screen) {
            case INTRO:
                if (buttonPressed == 0) {
                    ...
                    this.screen = ModifiedShiningLight.CUR_SCREEN.COMPLETE;
